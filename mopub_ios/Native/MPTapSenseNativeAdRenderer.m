//
//  MPTapSenseNativeAdRender.m
//  TapSense
//
//  Copyright (c) 2015 TapSense. All rights reserved.
//

#import "MPTapSenseNativeAdRenderer.h"
...
/**
 * A copy of MPStaticNativeAdRenderer class with minor difference
 * in +rendererConfigurationWithRendererSettings to support MPTapSenseNativeCustomEvent
 */

@interface MPTapSenseNativeAdRenderer () <MPNativeAdRendererImageHandlerDelegate>
...
@implementation MPTapSenseNativeAdRenderer
...
+ (MPNativeAdRendererConfiguration *)rendererConfigurationWithRendererSettings:(id<MPNativeAdRendererSettings>)rendererSettings
{
    ...
    config.supportedCustomEvents = @[@"MPTapSenseNativeCustomEvent"];
